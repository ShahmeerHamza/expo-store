            ...
            <DataTable style={styles.container}>
                <DataTable.Header style={styles.tableHeader}>
                    <DataTable.Title textStyle={{
                        color: 'white',
                        fontSize: 20,
                    }} style={{ flex: 4, justifyContent: 'flex-start' }}>Date</DataTable.Title>
                    <DataTable.Title textStyle={{
                        color: 'white',
                        fontSize: 20,
                    }} style={{ flex: 6, }}>Product Name</DataTable.Title>
                    <DataTable.Title textStyle={{
                        color: 'white',
                        fontSize: 20,
                    }} style={{ flex: 3, justifyContent: 'center' }}>Status</DataTable.Title>
                    <DataTable.Title textStyle={{
                        color: 'white',
                        fontSize: 20,
                    }} style={{ flex: 2, justifyContent: 'flex-end' }}>Qty</DataTable.Title>
                </DataTable.Header>
                {data?.map(
                    (item, index) => {
                        return (
